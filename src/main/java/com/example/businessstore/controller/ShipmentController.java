...
public class ShipmentController {
    ...
    @GetMapping("/orders/{orderId}/shipment") @PreAuthorize(SecurityExpressions.CAN_VIEW_ORDER_SHIPMENT) public ResponseEntity<ApiResponse<ShipmentResponse>> management(@PathVariable UUID orderId) { return ResponseEntity.ok(ApiResponse.success(service.getForManagement(orderId))); }
