 ...
 *
 * "Khổ & giá" và "Về chúng tôi" chưa có trang, cũng như /gio-hang và /dat-in ở bên phải
 * header. Chúng rơi vào catch-all và đáp trang chủ — xem danh sách đầy đủ trong App.tsx.
 */
const NAV = [
