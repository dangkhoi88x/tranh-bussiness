    ...
    >
      ...
      <nav
        ...
        style={{
          ...
          marginLeft: 'clamp(var(--space-4), 2.2vw, var(--space-8))',
          fontSize: 14,
          fontWeight: 500,
          whiteSpace: 'nowrap',
        }}
      >
        {NAV.map((n) => (
          <a
            key={n.label}
            href={n.href}
            {...(n.secondary ? { 'data-nav-secondary': '' } : {})}
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: 6,
      ...
      <div
        data-header-actions=""
        style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', marginLeft: 'auto', flex: 'none' }}
      >
        <button
          type="button"
        ...
        <a href="/gio-hang" aria-label="Giỏ hàng" style={{ ...iconBtn, position: 'relative', textDecoration: 'none' }}>
          <svg
            ...
            strokeLinecap="square"
          >
            <path d="M4 7h16l-1.4 12H5.4L4 7Z" />
      ...
      {searchOpen && (
        ...
        >
          ...
          <input
            ...
            placeholder="Tìm theo tên tranh, chủ đề, chất liệu…"
            maxLength={200}
