          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 13, color: 'var(--color-neutral-700)' }}>
                {formatSize(b.widthCm, b.heightCm) ?? formatPrice(b.price)}
              </span>
              <button
                type="button"
                className="btn btn-secondary"
                style={{ alignSelf: 'stretch', marginTop: 'auto', paddingTop: 'var(--space-3)', cursor: 'pointer' }}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)', padding: 'var(--space-8)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', borderTop: '2px solid var(--color-divider)' }}>
              {rows.map((r) => (
                ...
                >
                  <span
                    style={{ letterSpacing: '.12em', textTransform: 'uppercase', color: 'var(--color-neutral-700)' }}
                  >
                    {r.k}
                  </span>
            ...
            <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
              <a href={`/dat-in?san-pham=${book.slug}`} className="btn btn-primary">
                Đặt cuốn tương tự
              </a>
              <button type="button" className="btn btn-ghost" style={{ cursor: 'pointer' }} onClick={onNext}>
                Cuốn kế tiếp
              </button>
            </div>
          </div>
