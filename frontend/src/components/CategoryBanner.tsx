...
export function CategoryBanner() {
  ...
  return (
    ...
    >
      ...
      {error && (
        <p style={{ marginTop: 'var(--space-6)', fontSize: 13, color: 'var(--color-accent-700)' }}>
        ...
        {cats.map((c) => (
          ...
          >
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: 11, lineHeight: 1.4, color: 'var(--color-neutral-700)' }}>
                {c.description}
              </p>
            </div>
            <a
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 'var(--space-6)' }}>
        <a
          href="/danh-muc/tranh-canvas"
          className="btn btn-primary"
          style={{ display: 'inline-flex', alignItems: 'center', gap: 'var(--space-6)' }}
        >
