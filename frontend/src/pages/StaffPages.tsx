      ...
      <section className="catalog-panel">
        <div className="staff-toolbar">
          ...
          >
            ...
            />
            <button className="ghost-button">Tìm</button>
          </form>
          <small>{data?.totalElements ?? 0} tài khoản</small>
        </div>
        {loading ? (
          <p className="table-loading">Đang tải danh sách tài khoản…</p>
        ) : (
          <>
                  ...
                  <tr key={user.id}>
                    ...
                    <td className="table-actions">
                      {user.id !== session?.userId ? (
                        ...
                        <small>Không tự đổi quyền</small>
                      )}
                    </td>
                  </tr>
                ))}
            ...
            <Pagination data={data} onPage={setPage} label="tài khoản" />
          </>
        )}
      </section>
      {editing && (
        <UserRolesModal
          ...
          onSaved={(user) => {
            setEditing(null);
            setMessage(`Đã cập nhật role cho ${user.email}.`);
            void load();
          }}
        />
      )}
      {editingPermissions && staffRole && (
