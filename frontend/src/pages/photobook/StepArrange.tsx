...
export function StepArrange({ spreads, currentIdx, setCurrentIdx, onChangeLayout, onSetSlotFile, onSwapSlots, onSetSlotCrop, onAddCaption, onUpdateCaption, onRemoveCaption, history, onRemember, onUndo, onRedo, onAutoFillFiles, onMoveSpread, draftNotice, onBack, onNext }: {
...
export function LayoutThumb({ layout, active, onClick }: { layout: SpreadLayout; active: boolean; onClick: () => void }) {
  return (
