  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          style={{ margin: '0 0 var(--space-4)', fontSize: 12, color: 'var(--color-neutral-700)', textAlign: 'center' }}
        >
