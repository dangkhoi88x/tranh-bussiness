    ...
    <AdminOrderNotificationProvider>
      <Routes>
        <Route element={<AdminLayout />}>
          ...
          <Route element={<RequirePermission permission="CATEGORY_MANAGE" />}>
          ...
          <Route element={<RequirePermission permission="PRODUCT_MANAGE" />}>
            <Route path="art-sizes" element={<ArtSizesPage />} />
          </Route>
          <Route element={<RequirePermission permission="PRODUCT_MANAGE" />}>
            <Route path="photobook-templates" element={<PhotobookTemplatesPage />} />
          </Route>
          <Route element={<RequirePermission permission="FRAME_MANAGE" />}>
            <Route path="frames" element={<FramesPage />} />
          </Route>
          <Route element={<RequirePermission permission="ORDER_MANAGE" />}>
            <Route path="orders" element={<OrdersSearchPage />} />
            <Route path="orders/:orderId" element={<OrderDetailPage />} />
          </Route>
          <Route element={<RequirePermission permission="PAYMENT_MANAGE" />}>
            <Route path="payments" element={<PaymentsSearchPage />} />
          </Route>
          <Route element={<RequirePermission permission="CUSTOM_ORDER_MANAGE" />}>
            <Route path="custom-orders" element={<CustomOrdersPage />} />
            <Route path="photobooks" element={<PhotobookQueuePage />} />
          </Route>
          <Route element={<RequirePermission permission="SHIPMENT_MANAGE" />}>
            <Route path="shipments" element={<ShipmentsPage />} />
          </Route>
          <Route element={<RequirePermission permission="PROMOTION_MANAGE" />}>
