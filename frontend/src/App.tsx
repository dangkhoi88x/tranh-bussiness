...
function lazyPage<K extends string>(
  ...
  return function LazyRoute() {
    return (
      <Suspense fallback={<main className="page-loading">{loadingLabel}</main>}>
        <Loaded />
      </Suspense>
    );
  };
...
const PhotobookDetailRoute = lazyPage(
  () => import('./pages/PhotobookDetailPage'),
  'PhotobookDetailPage',
  'Đang tải trình dựng photobook…',
);
const PhotobookProjectRoute = lazyPage(
  () => import('./pages/PhotobookProjectPage'),
  'PhotobookProjectPage',
  'Đang tải cuốn photobook…',
);
const PhotobookArrangementRoute = lazyPage(
  () => import('./pages/PhotobookArrangementPage'),
  'PhotobookArrangementPage',
  'Đang tải bản dàn trang…',
);
const SharePreviewLoader = lazyPage(
  () => import('./pages/PhotobookSharePreviewPage'),
  'PhotobookSharePreviewPage',
  'Đang tải bản xem trước…',
);

function AdminAreaLoader() {
  return (
    <Suspense fallback={<main className="page-loading">Đang tải khu vực quản trị…</main>}>
      <AdminArea />
    </Suspense>
  );
}
