...
export const SPREAD_LAYOUTS: SpreadLayout[] = [
  { code: 'TRAN_DOI', name: 'Tràn đôi', slots: [{ x: 0, y: 0, w: 1, h: 1, bleed: true }] },
  {
    code: 'DOI_CAN',
    name: 'Đôi cân',
    slots: [
  ...
  {
    code: 'MOT_LON_MOT_NHO',
    name: 'Một lớn một nhỏ',
    slots: [
      { x: 0.04, y: 0.06, w: 0.58, h: 0.88, bleed: false },
      { x: 0.66, y: 0.3, w: 0.3, h: 0.4, bleed: false },
    ],
  },
  {
    code: 'BA_NGANG',
    name: 'Ba ngang',
    slots: [
      { x: 0.03, y: 0.15, w: 0.3, h: 0.7, bleed: false },
      { x: 0.35, y: 0.15, w: 0.3, h: 0.7, bleed: false },
      { x: 0.67, y: 0.15, w: 0.3, h: 0.7, bleed: false },
    ],
  },
  {
    code: 'CHU_L',
    ...
    slots: [
      { x: 0.04, y: 0.06, w: 0.58, h: 0.88, bleed: false },
      { x: 0.66, y: 0.06, w: 0.3, h: 0.42, bleed: false },
      { x: 0.66, y: 0.52, w: 0.3, h: 0.42, bleed: false },
    ],
  },
  {
    code: 'BON_O',
  ...
  },
  {
    ...
    name: 'Ba tấm',
    slots: [
      { x: 0.03, y: 0.08, w: 0.2, h: 0.84, bleed: false },
      { x: 0.26, y: 0.08, w: 0.48, h: 0.84, bleed: false },
      { x: 0.77, y: 0.08, w: 0.2, h: 0.84, bleed: false },
    ],
  },
  {
    code: 'SAU_O',
    name: 'Sáu ô',
    slots: [
      { x: 0.03, y: 0.05, w: 0.3, h: 0.43, bleed: false },
      { x: 0.35, y: 0.05, w: 0.3, h: 0.43, bleed: false },
      { x: 0.67, y: 0.05, w: 0.3, h: 0.43, bleed: false },
      { x: 0.03, y: 0.52, w: 0.3, h: 0.43, bleed: false },
      { x: 0.35, y: 0.52, w: 0.3, h: 0.43, bleed: false },
      { x: 0.67, y: 0.52, w: 0.3, h: 0.43, bleed: false },
    ],
  },
  {
    code: 'CONTACT_SHEET',
  ...
  // ── Wave 2 ──
  { code: 'PANORAMA', name: 'Toàn cảnh', slots: [{ x: 0.03, y: 0.25, w: 0.94, h: 0.5, bleed: false }] },
  {
    code: 'MOT_HAI',
    name: 'Một hai',
    slots: [
      { x: 0.04, y: 0.05, w: 0.92, h: 0.45, bleed: false },
      { x: 0.04, y: 0.55, w: 0.44, h: 0.4, bleed: false },
      { x: 0.52, y: 0.55, w: 0.44, h: 0.4, bleed: false },
    ],
  },
  {
    code: 'HAI_MOT',
    name: 'Hai một',
    slots: [
      { x: 0.04, y: 0.05, w: 0.44, h: 0.4, bleed: false },
      { x: 0.52, y: 0.05, w: 0.44, h: 0.4, bleed: false },
      { x: 0.04, y: 0.5, w: 0.92, h: 0.45, bleed: false },
    ],
  },
  {
    code: 'BAC_THANG',
  ...
  },
  {
    ...
    name: 'Khung đôi',
    slots: [
      { x: 0.08, y: 0.1, w: 0.34, h: 0.8, bleed: false },
      { x: 0.58, y: 0.1, w: 0.34, h: 0.8, bleed: false },
    ],
  },
  {
    code: 'BA_TANG',
  ...
  },
  {
    ...
    slots: [
      ...
      { x: 0.03, y: 0.64, w: 0.3, h: 0.31, bleed: false },
  ...
  { code: 'VIEN_LON', name: 'Viền lớn', slots: [{ x: 0.15, y: 0.12, w: 0.7, h: 0.76, bleed: false }] },
];
